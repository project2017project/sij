...
<section class="product-details-page">
  <div class="container">
                  ...
                  <div class="product-size">
                    ...
                    <ul class="siz-list">
                      ...
                      <li class="stock-<?php echo $productt->size_qty[$key];?> {{ $is_first ? 'active' : '' }}">
                        ...
                        <span class="box">{{ $data1 }}<span class="qty-label">( Sold Out )</span><span class="qty-price">( {{$productt->size_price[$key]}} )</span>
                  ...
                  <div id="product-details-tab">
                    <div class="top-menu-area">
                      <ul class="tab-menu">
                        ...
                        <li><a href="#tabs-2" style="display:none;">{{ $langg->lang93 }}</a></li>
                        <li><a href="#tabs-3">{{ $langg->lang94 }}({{ count($productt->ratings) }})</a></li>
                        @if($gs->is_comment == 1)
                        <li><a href="#tabs-4" style="display:none;">{{ $langg->lang95 }}(<span
    ...
    <div class="col-lg-3">
      ...
      <div class="seller-info mt-3" style="display:none;">
        <div class="content">
          <h4 class="title">
            {{ $langg->lang246 }}
          </h4>
