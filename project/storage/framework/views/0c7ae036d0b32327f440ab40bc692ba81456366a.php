      ...
      <div class="category-module hiraola-sidebar_categories">
        ...
        <div class="module-body">          
          <ul  class="module-list_item">
            ...
            <li>
              <a href="<?php echo e(route('front.onsale', $element->slug)); ?>"> <i class="icon licon-chevron-right"></i>  <?php echo e($element->name); ?> <span class="notranslate"></span> </a>
              ...
              <ul class="module-sub-list_item">
                ...
                <li>
                  <a href="<?php echo e(route('front.onsale', [$cat->slug, $subelement->slug])); ?>" ><i class="icon licon-chevron-right"></i> <?php echo e($subelement->name); ?> <span class="notranslate"></span></a>
                  ...
                  <ul  class="module-list_item">
                    ...
                    <li>
                      <a href="<?php echo e(route('front.onsale', [$cat->slug, $subelement->slug, $childcat->slug])); ?>"><i class="icon licon-chevron-right"></i>  <?php echo e($childcat->name); ?> <span class="notranslate"></span></a>
                    </li>
      ...
      <div class="hiraola-sidebar-catagories_area" style="display:none">
        <div class="hiraola-sidebar_categories">
          ...
          <div class="price-filter">
            <form id="catalogForm" action="<?php echo e(route('front.onsale', [Request::route('category'), Request::route('subcategory'), Request::route('childcategory')])); ?>" method="GET">
