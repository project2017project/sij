...
<div class="content-area">
  ...
  <div class="row row-cards-one tabs_cts">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12 tabs-rev-ct">
            <div class="card">
                <h5 class="card-header">Vendor Reports</h5>
	...
	<div  id="tab-1" class="tab-content current" >
        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            <form id="contactform" action="<?php echo e(route('vendor.vendorrecord.submit')); ?>" method="POST">
			...
			<div class="col-md-6 col-xl-3">
				<a href="<?php echo e(route('exportreport',['startdate'=>$startdate,'enddate'=>$enddates])); ?>" class="btn btn-info" >Export Filter Data</a>
				 </div>
			</div>        
			<?php endif; ?>
							...
							<thead>
								<tr>
									...
									<?php
                                        ...
                                        ?>										
									<tr>
				                        <td><a href="<?php echo e(route('vendor-order-vshow',$all_order['order_number'])); ?>"><?php echo e($all_order['order_number']); ?></a></td>
