...
?> 
						...
						<form id="acceptsform" class="form-horizontal" action="<?php echo e(route('admin-vendor-withdraw-accept',$withdraw->id)); ?>" method="POST" enctype="multipart/form-data">      
						                                 <?php echo e(csrf_field()); ?>

					   <input type="hidden" class="form-control"  id="settle" name="settle" value="1">    
					   <div class="row">
                        <div class="col-lg-6">
                                 <input type="text" class="input-field" placeholder="<?php echo e(__('Settle Amount')); ?>" name="amount" required="">              
                        </div>                    
                        <div class="col-lg-6">
                            <input type="text" class="form-control" id="note" name="note" placeholder="<?php echo e(__('Note')); ?>" >
                    </div>
