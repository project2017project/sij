...
/*----------------------------------------*/
	...
	var loadoptindislay = $(".siz-list li.active").html();

         $(".selectbox_wrap_list_optin").html(loadoptindislay);




	$(".selectbox_wrap_list_optin").on("click", function() {
        
         $(".siz-list").toggleClass("display");
    }); 


    $(".siz-list li").on("click", function() {
        
         $(".siz-list").removeClass("display");


         var optindislay = $(this).html();

         $(".selectbox_wrap_list_optin").html(optindislay);
