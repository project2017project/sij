...
class CurrencyController extends Controller
{
   public function __construct()
    ...
    public function datatables()
    {
	 ...
	 //*** JSON Request
    public function updatecurdatatables()
    {
         $datas = Currency::orderBy('id')->get();
         //--- Integrating This Collection Into Datatables
         return Datatables::of($datas)
    ...
    public function updatecurrency()
    {
        ...
        return view('admin.currency.updatecurrency',compact('currencies'));
    }
    ...
    {
		$count = $request->cur_tot;
		for($i=0;$i<=$count-1;$i++){
                Currency::where('id',$request->cur_id[$i])->update(['value' => $request->cur_value[$i],'original_val' => $request->cur_orgvalue[$i]]);
            }
