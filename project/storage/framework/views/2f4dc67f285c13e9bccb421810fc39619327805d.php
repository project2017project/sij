...
<div class="vendor-banner newstyle" style="background: url(<?php echo e($cat->photo ? asset('assets/images/categories/'.$cat->photo):asset('assets/images/pre_img.jpg')); ?>); background-repeat: no-repeat; background-size: cover;background-position: center;">
  </div>
...
<div class="vendor-banner newstyle" style="background: url(<?php echo e($subcat->photo ? asset('assets/images/subcategory/'.$subcat->photo):asset('assets/images/pre_img.jpg')); ?>); background-repeat: no-repeat; background-size: cover;background-position: center;">
  </div>
...
<div class="vendor-banner newstyle" style="background: url(<?php echo e($childcat->photo ? asset('assets/images/childcategory/'.$childcat->photo):asset('assets/images/pre_img.jpg')); ?>); background-repeat: no-repeat; background-size: cover;background-position: center;">
  </div>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $("#slider-range").slider({
      ...
      min: 0,
      max: 5000,
      values: [<?php echo e(isset($_GET['min']) ? $_GET['min'] : '0'); ?>, <?php echo e(isset($_GET['max']) ? $_GET['max'] : '5000'); ?>],
      step: 5,
