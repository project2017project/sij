            ...
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                <span class="t-invoice">{{ __('PACKAGING SLIP') }}</span><br><br>
...
@endif</span> <br />
        ...
        <table class="invoice-items" cellpadding="0" cellspacing="0">    
            <tr class="heading">
                ...
                <td><span class="t-price">{{ App\Models\Currency::where('sign',$order->inr_currency_sign)->first()->name }} {{ round($subtotal, 2) }}</span></td>
            </tr>
        </table>
