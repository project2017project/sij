...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                               <div class="col-lg-12">
                      <h4 class="heading"><?php echo e(__('Exchange Details')); ?> <a class="add-btn" href="<?php echo e(route('admin-open-exchange')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
                      <ul class="links">
                        <li>
                          <a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a>
                        </li>
                        <li>
                          <a href="javascript:;"><?php echo e(__('Exchange Details')); ?></a>
                        </li>                        
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        ?>
                                                    ...
                                                    <table class="table"> 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo e($data->tracking_code); ?></td>
                                                                                                    ...
                                                                                                    <tr>
                                                                <th><?php echo e(__("Customer Tracking Url")); ?></th>
                                                                <td><a target="_blank" href="<?php echo e($data->tracking_url); ?>"><?php echo e($data->tracking_url); ?></a></td>
                                                            </tr>                     
												...
												<div class="row">
												<div class="col-md-6">
												<form  method="POST" action="<?php echo e(route('admin-exchangedocument-update',$data->id)); ?>" enctype="multipart/form-data" id="documentform">
												...
												<button class="exchangedform-btn" type="submit"><?php echo e(__('Exchange')); ?></button>
												</form>
												</div-->
												
												<div class="col-md-2">
												<form  method="POST" action="<?php echo e(route('admin-dstatus-exchange',$data->id)); ?>" enctype="multipart/form-data" id="declineform">
												<?php echo e(csrf_field()); ?>
