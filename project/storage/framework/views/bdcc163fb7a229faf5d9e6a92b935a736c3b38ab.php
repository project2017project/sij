...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Credit Note')); ?> 				
				<ul class="links">
					<li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>					
					<li><a href="javascript:;"><?php echo e(__('Add Credit Note')); ?></a></li>					
				</ul>
			</div>
		</div>
	</div>

	<form id="addcreditnoteform" action="<?php echo e(route('addstore-creditnote-submit')); ?>" method="POST" enctype="multipart/form-data">
...
<table class="table">
  ...
  <?php $__currentLoopData = $vdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alldata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<?php
                                     ...
                                     ?>
                                       <?php
                                    $dispute_data = App\Models\CreditNote::where('order_id','=',$alldata->order_id)->where('vendor_id','=',$alldata->user_id)->where('product_id','=',$alldata->product_id)->get();
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php $__currentLoopData = $vdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vdatas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									 <?php
                                                ...
                                                ?>
                                    <option data-href="<?php echo e(route('product-credit-pload',$vdatas->product_id)); ?>" value="<?php echo e($vdatas->product_id); ?>"  data-hreftax="<?php echo e(route('product-data-ptload',$vdatas->product_id)); ?>" value="<?php echo e($vdatas->product_id); ?>"  dataidp=".setproduct<?php echo e($j); ?>">(<?php echo e($productsku->sku); ?>) <?php echo e($productsku->name); ?></option>
									<?php $j++ ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					                    </select>
									...
									<div class="row">
										<div class="col-lg-12"><div class="left-area"><h4 class="heading"><?php echo e(__('Final Debit Amount')); ?>* </h4></div></div>
										<div class="col-lg-12"><input type="text" class="input-field finaldnamt" placeholder="<?php echo e(__('Final Debit Amount')); ?>" name="amount" required="" ></div>
									</div>
                                    ...
                                    <div class="row">
										...
										<select name="prreason" onchange="changereason(this.value);" required> 
                                         ...
                                         <option value="Wrong product delivered to customer">Wrong product delivered to customer</option>
										  ...
										  <option value="Shipping Charges">Shipping Charges</option>
										  <option value="Extension Chain Charges">Extension Chain Charges</option>
										  <option value="Refund On Penalty Charges">Refund On Penalty Charges</option>
                                   ...
                                   <div class="row">
										...
										<div class="modal fade" id="creditmod" tabindex="-1" role="dialog" aria-labelledby="creditmod" aria-hidden="true">                        
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">            
            <div class="modal-body">
                <p class="text-center">Are you Sure You want to Create Credit Note Request?</p>
				<button class="addcreditnoteform-btn btn btn-success" style="margin-top : 0; width:auto; height:auto; font-size : 1rem; 
    background-color: #28a745; border: 1px solid transparent; border-color: #28a745;" type="submit"><?php echo e(__('Confirm')); ?></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
												...
												<a href="javascript:;" class="btn btn-info" data-toggle="modal" data-target="#creditmod"><?php echo e(__('Add')); ?></a>
													</div>
									</div>
							</div>
						</div>
