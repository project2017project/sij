...
@section('content')
                        ...
                        @include('includes.admin.form-both')  
											...
											<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="gst_number" placeholder="{{ __('GST Number') }}" required="" value="{{$data->gst_number}}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text-area" class="input-field" name="address" placeholder="{{ __('Address') }}" required="" value="{{$data->address}}">
													</div>
												</div>
...
@if(Auth::check())
	...
	<option data-href="{{ route('front-state-load',$datas->id) }}" value="{{ $datas->name }}" {{ Auth::user()->admin_country == $datas->name ? 'selected' : '' }}>{{ $datas->name }}</option>		
	@endforeach
@else
	@foreach (DB::table('countries')->get() as $datas)
...
@endif
												...
												<div class="row">
													...
													<div class="col-lg-7">
														...
														@if($data->admin_state)
															<option value="{{ $data->admin_state }}">{{ $data->admin_state }}</option>
															@else
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="city" placeholder="{{ __('City') }}" required="" value="{{$data->city}}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="zip_code" placeholder="{{ __('Zip Code') }}" required="" value="{{$data->zip_code}}">
													</div>
												</div>
