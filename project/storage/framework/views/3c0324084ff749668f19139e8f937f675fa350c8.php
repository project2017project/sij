			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="links">
						...
						<li><a href="<?php echo e(route('admin-prod-variationproduct')); ?>"><?php echo e(__("Variation Products")); ?></a></li>
					</ul>
				</div>
			</div>
		</div>
					...
					<div class="table-responsiv">	
					    ...
					    <form id="geniusform" class="form-horizontal" action="<?php echo e(route('admin-prod-price-update')); ?>" method="POST" enctype="multipart/form-data">      
							...
							<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
								<thead>
									<tr>
				                        <th><?php echo e(__("Product Image")); ?></th><th><?php echo e(__("Name")); ?></th><th><?php echo e(__("SKU")); ?></th>
				                        <th><?php echo e(__("Price")); ?></th><th><?php echo e(__("Stock")); ?></th><th><?php echo e(__("Category List")); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		var table = $('#geniustable').DataTable({
               ...
               serverSide: true,
               ajax: {
                  url: "<?php echo e(route('admin-prod-variation-datatables')); ?>",
                  type: 'GET',
                  data: function (d) {
                    d.category         = $('#cat').val();
                    d.subcat           = $('#subcat').val();
