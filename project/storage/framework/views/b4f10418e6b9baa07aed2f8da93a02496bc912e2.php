...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Refunds Paid')); ?></h4>
				<ul class="links">
					<li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>
					<li><a href="javascript:;"><?php echo e(__('Refunds Paid')); ?></a></li>					
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-12">
				<div class="mr-table allproduct">
                  <?php echo $__env->make('includes.admin.form-success', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>				
					...
					<div class="row">                    							
                                                <div class="text-left" >                                                    
                                                     <a href="<?php echo e(route('admindw-raise-dispute',['status'=>'none'])); ?>" class="btn btn-warning" >Export</a>
                                                </div>
                                            </div>
						<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th><?php echo e(__('Tracking Partner')); ?></th>
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		   ...
		   ajax: {
                  url: "<?php echo e(route('admin-load-resolved-dispute','none')); ?>",
                  type: 'GET',
                  data: function (d) {    
		   ...
		   columns: [
					...
					{ data: 'tracking_partner', name: 'tracking_partner' },
