...
<div class="content-area">
            ...
            <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
              ...
              @include('includes.admin.form-both')  
                ...
                <div class="row">
                  <label class="control-label col-sm-3" for="gplus">{{ __('You Tube') }} *</label>
                  <div class="col-sm-6">
                ...
                <div class="row">
                  <label class="control-label col-sm-3" for="twitter">{{ __('Pinterest') }} *</label>
                  <div class="col-sm-6">
                ...
                <div class="row">
                  <label class="control-label col-sm-3" for="linkedin">{{ __('Instagram') }} *</label>
                  <div class="col-sm-6">
                    <input class="form-control" name="linkedin" id="linkedin" placeholder="{{ __('http://instagram.com/') }}" required="" type="text" value="{{$data->linkedin}}">
                  </div>
                  <div class="col-sm-3">
                    <label class="switch">
