										...
										<div class="product-description">
											...
											<form id="geniusform" action="{{ route('admin-vendor-edit',$data->id) }}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="bank_name" placeholder="Bank Name" value="{{ $data->bank_name }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="branch" placeholder="Branch" value="{{ $data->branch }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="ifsc_code" placeholder="IFSC Code" value="{{ $data->ifsc_code }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="account_holder_name" placeholder="Account Holder Name" value="{{ $data->account_holder_name }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="account_number" placeholder="Account Number" value="{{ $data->account_number }}">
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __("Shop Logo") }} </h4>
														</div>
													</div>
													<div class="col-lg-7">
													<img src="{{ asset('assets/images/users/'.$data->shop_logo) }}">
