                            ...
                            '<span class="remove size-remove"><i class="fas fa-times"></i></span>'+
                                '<div  class="row">'+
                                    ...
                                    '<div class="col-md-4 col-sm-6">'+
                                        ...
                                        '</label>'+
                                        '<input type="number" name="size_qty[]" class="input-field" placeholder="'+langg.lang651+'" value="1" min="0">'+
                                    '</div>'+
                                    '<div class="col-md-4 col-sm-6">'+
                                        '<label>'+
                                        'Size Price :'+
                                        ...
                                        '</label>'+
                                        '<input type="number" name="size_price[]" class="input-field var_price_s" placeholder="'+langg.lang653+'" value="0" min="0">'+
                                    '</div>'+
                                '</div>'+
                            '</div>'
                        +'');
...
$('input[type="checkbox"]').addClass('vendor_checkbox_product');
