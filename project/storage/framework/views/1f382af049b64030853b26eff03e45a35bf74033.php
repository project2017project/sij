...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                               <div class="col-lg-12">
                      <h4 class="heading"><?php echo e(__('Rto Details')); ?> <a class="add-btn" href="<?php echo e(route('vendor-rto-index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
                      <ul class="links">
                        <li>
                          <a href="<?php echo e(route('vendor-dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a>
                        </li>
                        <li>
                          <a href="javascript:;"><?php echo e(__('Rto')); ?></a>
                        </li>                        
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        ?>
												...
												<?php }else{?>
												<div class="text-left" style="display:inline-block; width:100%; padding:30px 20px;"><a href="javascript:void(0)" class="add-btn btn-md"> <span data-toggle="modal" data-target="#rtoshipform-all" class="">Add Shipping<span></span></span></a></div>
												<?php } ?>
												<form  method="POST" action="<?php echo e(route('vendor-rto-update',$data->id)); ?>" enctype="multipart/form-data" id="rtoshipform">
												<?php echo e(csrf_field()); ?>

												<div class="modal fade" id="rtoshipform-all" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
                        ...
                        <div class="col-lg-12">
                         <input type="text" class="input-field"  name="text" placeholder="<?php echo e(__('Tracking URL')); ?>" required="">          
                                        ...
                                        <div class="modal-footer justify-content-center">
                                            <p align="center"><button type="submit"  class="rtoshipform-btn btn btn-success referesh-btn" name="save">ADD</button></p>
                                        </div>
                                    </div>
                                </div>
								</div>
