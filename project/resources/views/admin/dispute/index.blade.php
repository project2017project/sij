...
<div class="content-area">
	...
	<form id="disputesforms" action="{{route('admin-disputes-submit')}}" method="POST" enctype="multipart/form-data">
		{{csrf_field()}}
					...
					<div class="col-lg-12">
						<div class="product-description">
							<div class="body-area">						
                                    ...
                                    <option data-href="{{ route('orders-data-loads',$userid->id) }}" value="{{$userid->id}}">{{$userid->shop_name}}</option>
                                    @endforeach
					                    </select>
