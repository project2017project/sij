...
class User extends Authenticatable
{
    ...
    protected $fillable = ['name', 'photo', 'zip','state', 'residency', 'city', 'country', 'address', 'phone', 'fax', 'email','password','affilate_code','verification_link','shop_name','owner_name','shop_number','shop_address','reg_number','shop_message','bank_name','branch','ifsc_code','account_holder_name','account_number','shop_logo','is_vendor','shop_details','shop_image','f_url','g_url','t_url','l_url','f_check','g_check','t_check','l_check','shipping_cost','date','mail_sent','percentage_commission'];
