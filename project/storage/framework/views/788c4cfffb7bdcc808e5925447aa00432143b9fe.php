                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading"><?php echo e(__('Original Inr')); ?> *</h4>
                                <small><?php echo e(__('Please Enter Original Inr Value ')); ?></small>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="original_val" placeholder="<?php echo e(__('Enter Original Inr Value')); ?>" required="" value="<?php echo e($data->original_val); ?>">
                          </div>
                        </div>
