			<?php if(count($vprods) > 0): ?>
					<?php $__currentLoopData = $vprods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


<?php
$total_stock = 0;
?>	
<?php if($prod->stock || $prod->size_qty): ?>
	<?php
$total_stock = $prod->stock;
?>
<?php if(!empty($prod->size_qty)): ?>
 <?php $__currentLoopData = $prod->size_qty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skey => $skeydata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php
$total_stock += $prod->size_qty[$skey];
?> 
...
<?php endif; ?>
				...
				<div class="col-lg-12">
					<div class="page-center mt-5">
						<?php echo $vprods->appends(['search' => request()->input('search')])->links(); ?>
