...
<table class="table">
 ...
 @endforeach
									...
									<div class="row">
										...
										<div class="col-lg-12"><input type="number" class="input-field rdqty" placeholder="{{ __('Quantity') }}" name="quantity" min="1" value="{{$alldata->qty-$vender_data->product_item_qty}}" required=""></div>
									</div>
    ...
    background-color: #28a745; border: 1px solid transparent; border-color: #28a745;" type="submit">{{ __('Confirm') }}</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">{{ __('Cancel') }}</button>
												...
												<a href="javascript:;" class="btn btn-info" data-toggle="modal" data-target="#exchangemod">{{ __('Add') }}</a>
										</div>
									</div>
							</div>
						</div>
