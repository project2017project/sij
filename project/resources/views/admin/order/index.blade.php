...
<div class="content-area">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li><a href="{{ route('admin-order-index') }}">{{ __('All Orders') }}({{$all__count}})</a></li>
					<li><a href="{{route('admin-order-pending')}}"> {{ __('Pending Orders') }} ({{$pending__count}})</a></li>
            <li><a href="{{route('admin-order-processing')}}"> {{ __('Processing Orders') }}({{$processing__count}})</a></li>
            <li><a href="{{route('admin-order-shipping')}}"> {{ __('Shipped Orders') }}({{$od__count}})</a></li>
            <li><a href="{{route('admin-order-completed')}}"> {{ __('Completed Orders') }}({{$completed_count}})</a></li>
            <li><a href="{{route('admin-order-declined')}}"> {{ __('Declined Orders') }}({{$declined__count}})</a></li>
			<li><a href="{{route('admin-order-refundod')}}"> {{ __('Refund Orders') }}({{$refund_count}})</a></li>
				</ul>
			</div>
		</div>
	</div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">  
         		<a href="javascript:void(0)" class="add-btn"> <span data-toggle="modal" data-target="#model-status" class="remove-mobile">Bulk Edit<span></span></span></a>
						...
						<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th><input type="checkbox"  id="checkAll">{{ __('Order Id') }}</th>
    ...
    <div class="panel-body">
      ...
      <a href="{{ route('all-excel-file',['status'=>'none']) }}" class="btn btn-info" >ALL</a>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-2"> 
      <a href="{{ route('excel-file',['status'=>'none']) }}" class="btn btn-info" >Completed CSV</a>
      </div>
	  <div class="col-xs-12 col-sm-12 col-md-2"> 
      <a href="{{ route('shipping-excel-file',['status'=>'none']) }}" class="btn btn-info" >Shipping CSV</a>
      </div>
	  <div class="col-xs-12 col-sm-12 col-md-2"> 
      <a href="{{ route('process-excel-file',['status'=>'none']) }}" class="btn btn-info" >Processing CSV</a>
      </div>
                        </div>
    </div>
  </div>
