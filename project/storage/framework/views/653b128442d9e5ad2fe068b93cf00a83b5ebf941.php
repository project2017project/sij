    ...
    <div class="invoice-box">
        ...
        <table class="comisson_table" cellpadding="0" cellspacing="0">
            <tr class="comission_heading">
                ...
                <td>
                    <span class="t-payment-method"><?php echo e(__('Comission')); ?></span>
                </td>
                ...
                <td>
                    <span class="t-payment-method"><?php echo e(__('Gross Payment')); ?></span>
                </td>
                <td>
                    <span class="t-payment-method"><?php echo e(__('TCS 1%')); ?></span>
                </td>
                <td>
                    <span class="t-payment-method"><?php echo e(__('Net Amount')); ?></span>
                </td>
            </tr>
			...
			<?php if($product['item']['user_id'] != 0): ?>
                ...
                <td>
                    ...
                    <span><?php echo e('SKU : '.$productsku->sku); ?></span>
				<?php if(!empty($product['size'])): ?>   <br />	<span>                                            
<p><b>Option : </b> <?php echo e(str_replace('-',' ',$product['size'])); ?> </p>
				...
				<?php
                                            ...
                                            ?> 
                    <span class="t-payment-method"><?php echo e(App\Models\Currency::where('sign',$order->inr_currency_sign)->first()->name); ?> <?php echo e(round($commission, 2)); ?></span>
                </td>
				...
				<?php
                                            ...
                                            ?> 
                    <span class="t-payment-method"> <?php echo e(App\Models\Currency::where('sign',$order->inr_currency_sign)->first()->name); ?> <?php echo e(round($gross_payment, 2)); ?> </span>
                </td>
                <td>
				...
				<?php
                                            ...
                                            ?> 
	 <?php endif; ?>
                    <span class="t-payment-method"> <?php echo e(App\Models\Currency::where('sign',$order->inr_currency_sign)->first()->name); ?> <?php echo e(round($tcs_payment, 2)); ?>  </span>
                </td>
                <td>
				<?php
                                            $net_payment = $gross_payment-$tcs_payment;
                                            ?>
                    <span class="t-payment-method"> <?php echo e(App\Models\Currency::where('sign',$order->inr_currency_sign)->first()->name); ?> <?php echo e(round($net_payment, 2)); ?>  </span>
                </td>
            </tr>
			<?php endif; ?>
			<?php endif; ?>
            ...
            <tr class="comission_heading">
                ...
                <td>
                    <span class="t-payment-method"><?php echo e(__('Comission')); ?></span>
                                ...
                                <td>
                                    <span class="t-payment-method"><?php echo e(__('IGST 18%')); ?></span>
                                </td>
