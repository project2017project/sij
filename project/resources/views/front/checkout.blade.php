								...
								<div class="content-box">
									...
									<div class="content">
										<div class="personal-info">
											<h5 class="title">
												{{ $langg->lang746 }}:  @if(!Auth::guard('web')->check()) <span style="float: right; font-size : 15px; font-weight:400;"> Already have an account ? <a href="{{ route('user.login') }}"> Login</a> </span> @endif 
											</h5>
											<div class="row">
												<div class="col-lg-6">
												    <label>Your Name <abbr class="required text-danger" title="required">*</abbr></label>
													<input type="text" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)"  id="personal-name" class="form-control" name="personal_name" placeholder="{{ $langg->lang747 }}" value="{{ Auth::check() ? Auth::user()->name : '' }}" {!! Auth::check() ? 'readonly' : '' !!}>
												</div>
												<div class="col-lg-6">
										...
										<div class="billing-address">
											...
											<div class="row">
											<div class="col-lg-6 hidden-select {{ $digital == 1 ? 'hidden-select' : '' }}">
												...
												<div class="col-lg-6">
												     <label>{{ $langg->lang152 }} <abbr class="required text-danger" title="required">*</abbr></label>
												...
												<div class="col-lg-6">
												    <label>{{ $langg->lang153 }} <abbr class="required text-danger" title="required">*</abbr></label>
												...
												<div class="col-lg-12">
												    <label>{{ $langg->lang154 }} <abbr class="required text-danger" title="required">*</abbr></label>
													<input class="form-control" type="text" name="email"
														placeholder="{{ $langg->lang154 }}" required=""
														value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->email : '' }}">
												</div>
												<div class="col-lg-6">
												    <label>{{ $langg->lang155 }} <abbr class="required text-danger" title="required">*</abbr></label>
												...
												<div class="col-lg-6">
												    <label>{{ $langg->lang158 }} <abbr class="required text-danger" title="required">*</abbr></label>
													<input class="form-control" type="text" name="city"
														placeholder="{{ $langg->lang158 }}" required=""
														value="{{ Auth::guard('web')->check() ? Auth::guard('web')->user()->city : '' }}">
												</div>
												<div class="col-lg-6">
												    <label>{{ $langg->lang159 }} <abbr class="required text-danger" title="required">*</abbr></label>
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="nav flex-column"  role="tablist" aria-orientation="vertical">
															...
															@if($gs->is_ccavenue == 1)
													            <a class="nav-link payment" data-val="" data-show="no" data-form="{{route('ccavenue.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'ccavenue','slug2' => 0]) }}"  id="v-pills-tab5-tab" data-toggle="pill" href="#v-pills-tab5" role="tab" aria-controls="v-pills-tab5" aria-selected="false">
																		<div class="icon">
																				<span class="radio"></span>
																		</div>
																		<p>
														...
														@if($gs->cod_check == 1)
														 @if($digital == 0)
															<a class="nav-link payment cash-ondel" data-val="" data-show="no" data-form="{{route('cash.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'cod','slug2' => 0]) }}" id="v-pills-tab3-tab" data-toggle="pill" href="#v-pills-tab3" role="tab" aria-controls="v-pills-tab3" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>Gift Cards</p>
										...
										<div class="order-area">
											...
											<div class="order-item">
												...
												<div class="product-content">
													...
													<div class="unit-price">
														<h5 class="label">@if(!empty($product['item']['variation_title'])){{ $product['item']['variation_title'] }} @else {{ $langg->lang312 }} @endif : </h5>
                       ...
                       @include('includes.admin.form-login')
                        <form id="registerform" action="{{route('user-register-submit')}}" method="POST">
                          {{ csrf_field() }}
                            ...
                            <div class="form-input">
                                <input type="text" class="User Name" name="phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  placeholder="{{ $langg->lang184 }}" required="">
