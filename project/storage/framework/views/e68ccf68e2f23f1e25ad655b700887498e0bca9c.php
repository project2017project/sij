...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Refund Orders')); ?></h4>
				<ul class="links">
					<li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>
					<li><a href="javascript:;"><?php echo e(__('Orders')); ?></a></li>
					<li><a href="<?php echo e(route('admin-order-refundod')); ?>"><?php echo e(__('All Refund Orders')); ?></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		   ...
		   ajax: {
                  url: "<?php echo e(route('admin-refundod-datatables','none')); ?>",
                  type: 'GET',
                  data: function (d) {
