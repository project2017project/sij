                ...
                <div class="special-box">
                    ...
                    <div class="footer-area">
                        ...
                        <a href="{{ route('vendor-order-invoice',$order->order_number) }}" class="mybtn1"><i class="fas fa-eye"></i>{{ $langg->lang555 }}</a>
                         <a href="javascript:;" data-href="{{route('vendor-order-track',$vorder->id)}}" class="mybtn1 track" data-toggle="modal" data-target="#modal1"><i class="fas fa-truck"></i> Shipping Details</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="mr-table">
                    ...
                    <div class="table-responsiv">
                        <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                            <thead>
                                <tr><th>SKU</th><th>Image</th><th>{{ $langg->lang568 }}</th><th>{{ $langg->lang569 }}</th><th>{{ $langg->lang570 }}</th><th>{{ $langg->lang539 }}</th><th>{{ $langg->lang574 }}</th></tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($product['size'])
                                        <p><strong>@if(!empty($product['item']['variation_title'])){{ $product['item']['variation_title'] }} @else size or color @endif :</strong> {{str_replace('-',' ',$product['size'])}}</p>
                                        @endif
                                        @if($product['color'])
