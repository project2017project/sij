							...
							<div class="body-area">		
								<div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<ul class="list"><li><input name="size_check" type="checkbox" id="size-check" value="1"> <label for="size-check"> {{ __('Enable Variation') }}</label></li></ul>
										</div>
									</div>
													...
													<div class="size-area">
														...
														<div class="row">
															<div class="col-md-4 col-sm-6">
																<label>{{ __('Variation Name') }} :<span>{{ __('(eg. Enter Variation)') }}</span></label>
																<input type="text" name="size[]" class="input-field" placeholder="{{ __('Variation Name') }}">
															</div>
															<div class="col-md-4 col-sm-6">
																<label>{{ __('Variation Qty') }} :<span>{{ __('(Number of quantity of this Variation)') }}</span></label>
																<input type="number" name="size_qty[]" class="input-field" placeholder="{{ __('Variation Qty') }}" value="1" min="1">
															</div>
															<div class="col-md-4 col-sm-6">
																<label>{{ __('Variation Price') }} :<span>{{ __('(This price will be added with base price)') }}</span></label>
																<input type="number" name="size_price[]" class="input-field" placeholder="{{ __('Variation Price') }}" value="0" min="0">
															</div>
														</div>
													</div>
												</div>
