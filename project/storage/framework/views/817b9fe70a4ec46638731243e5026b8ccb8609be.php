...
<div class="content-area">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li><a href="<?php echo e(route('admin-order-index')); ?>"><?php echo e(__('All Orders')); ?>(<?php echo e($all__count); ?>)</a></li>
					<li><a href="<?php echo e(route('admin-order-pending')); ?>"> <?php echo e(__('Pending Orders')); ?> (<?php echo e($pending__count); ?>)</a></li>
            <li><a href="<?php echo e(route('admin-order-processing')); ?>"> <?php echo e(__('Processing Orders')); ?>(<?php echo e($processing__count); ?>)</a></li>
            <li><a href="<?php echo e(route('admin-order-shipping')); ?>"> <?php echo e(__('Shipped Orders')); ?>(<?php echo e($od__count); ?>)</a></li>
            <li><a href="<?php echo e(route('admin-order-completed')); ?>"> <?php echo e(__('Completed Orders')); ?>(<?php echo e($completed_count); ?>)</a></li>
            <li><a href="<?php echo e(route('admin-order-declined')); ?>"> <?php echo e(__('Declined Orders')); ?>(<?php echo e($declined__count); ?>)</a></li>
			<li><a href="<?php echo e(route('admin-order-refundod')); ?>"> <?php echo e(__('Refund Orders')); ?>(<?php echo e($refund_count); ?>)</a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="product-area">
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">  
         		<a href="javascript:void(0)" class="add-btn"> <span data-toggle="modal" data-target="#model-status" class="remove-mobile">Bulk Edit<span></span></span></a>
						...
						<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th><input type="checkbox"  id="checkAll"><?php echo e(__('Order Id')); ?></th>
    ...
    <div class="panel-body">
      ...
      <a href="<?php echo e(route('all-excel-file',['status'=>'none'])); ?>" class="btn btn-info" >ALL</a>
      </div>
      <div class="col-xs-12 col-sm-12 col-md-2"> 
      <a href="<?php echo e(route('excel-file',['status'=>'none'])); ?>" class="btn btn-info" >Completed CSV</a>
      </div>
	  <div class="col-xs-12 col-sm-12 col-md-2"> 
      <a href="<?php echo e(route('shipping-excel-file',['status'=>'none'])); ?>" class="btn btn-info" >Shipping CSV</a>
      </div>
	  <div class="col-xs-12 col-sm-12 col-md-2"> 
      <a href="<?php echo e(route('process-excel-file',['status'=>'none'])); ?>" class="btn btn-info" >Processing CSV</a>
      </div>
                        </div>
    </div>
  </div>
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		   ...
		   ajax: {
                  url: "<?php echo e(route('admin-order-datatables','none')); ?>",
                  type: 'GET',
                  data: function (d) {
		   ...
		   columns: [
					...
					{ data: 'exchange_status', name: 'exchange_status' },
