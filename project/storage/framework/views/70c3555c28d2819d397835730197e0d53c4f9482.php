...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Process Orders')); ?></h4>
				<ul class="links">
					<li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>
					<li><a href="javascript:;"><?php echo e(__('Orders')); ?></a></li>
					<li><a href="<?php echo e(route('admin-order-processing')); ?>"><?php echo e(__('All Process Orders')); ?></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		   ...
		   ajax: {
                  url: "<?php echo e(route('admin-process-datatables','processing')); ?>",
                  type: 'GET',
                  data: function (d) {
