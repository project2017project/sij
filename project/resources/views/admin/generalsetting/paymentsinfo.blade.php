...
<hr>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_ccavenue == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-ccavenue',1)}}" {{ $gs->is_ccavenue == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-ccavenue',0)}}" {{ $gs->is_ccavenue == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                          ...
                          <div class="row justify-content-center">
                            <div class="col-lg-3">
                              <div class="left-area">
                                  <h4 class="heading">{{ __('Ccavenue Merchant') }} *
                                    </h4>
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <input type="text" class="input-field" placeholder="{{ __('Ccavenue Merchant') }}" name="ccavenue_merchant" value="{{ $gs->ccavenue_merchant }}" required="">
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Ccavenue Secret') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Ccavenue Secret') }}" name="ccavenue_secret" value="{{ $gs->ccavenue_secret }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Ccavenue Website') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Ccavenue Website') }}" name="ccavenue_website" value="{{ $gs->ccavenue_website }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Ccavenue Industry') }} *
                                  </h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <input type="text" class="input-field" placeholder="{{ __('Ccavenue Industry') }}" name="ccavenue_industry" value="{{ $gs->ccavenue_industry }}" required="">
                          </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Ccavenue Text') }} *</h4>

                            </div>
                          </div>
                          <div class="col-lg-6">
                            <textarea class="input-field" name="ccavenue_text" placeholder="{{ __('Ccavenue Text') }}">{{ $gs->ccavenue_text }}</textarea>
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Ccavenue Sandbox Check') }} *
                                  </h4>
                            </div>
                          </div>
                          ...
                          <div class="col-lg-6">
                            <label class="switch">
                              <input type="checkbox" name="ccavenue_mode" value="1" {{ $gs->ccavenue_mode == 'sandbox' ? "checked":"" }}>
                              <span class="slider round"></span>
                            </label>
                          </div>
                          </div>
