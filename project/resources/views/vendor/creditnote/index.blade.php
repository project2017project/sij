...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading">{{ __('Credit Note') }}</h4>
				<ul class="links">
					<li><a href="{{ route('vendor-dashboard') }}">{{ __('Dashboard') }} </a></li>
					<li><a href="javascript:;">{{ __('Credit Note') }}</a></li>					
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="mr-table allproduct">					 
					...
					<div class="row">                    							
                                                <div class="text-left" >                                                    
                                                     <a href="{{ route('vendordw-credit-data',['status'=>'none']) }}" class="btn btn-warning" >Export</a>
                                                </div>
											@if($pending__count)		
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		   ...
		   ajax: {
                  url: "{{ route('vendor-credit-datatables','none') }}",
                  type: 'GET',
                  data: function (d) { 
