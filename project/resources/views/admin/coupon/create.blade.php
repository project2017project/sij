                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-coupon-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Cart Total') }} </h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="cart_total_limit" placeholder="{{ __('Cart Total') }}" required="" value="">
                          </div>
                        </div>
                         ...
                         <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('User Limit To Use Code') }} </h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="user_used_count" placeholder="{{ __('User Limits') }}" required="" value="">
                          </div>
                        </div>
                    ...
                    <div class="custom-control custom-checkbox">
                      ...
                      <label class="custom-control-label" for="gift_voucher">Gift Voucher</label>
						 ...
						 <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="email_address" placeholder="{{ __('Email Address') }}" required="" value="">
                          </div>
                        </div>
