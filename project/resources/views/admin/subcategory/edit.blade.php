                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-subcat-update',$data->id)}}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                                <div id="image-preview" class="img-preview" style="background: url({{ $data->photo ? asset('assets/images/subcategory/'.$data->photo):asset('assets/images/noimage.png') }});">
						...
						<div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload">
                              <div id="image-preview" class="img-preview" style="background: url({{ $data->image ? asset('assets/images/subcategory/'.$data->image):asset('assets/images/noimage.png') }});">
						...
						<div class="row">
                          ...
                          <div class="col-lg-7">
						   <input type="text" class="input-field" name="meta_title" placeholder="{{ __('Enter Meta Title') }}" required="" value="{{$data->meta_title}}">                            
                          </div>
                        </div>
						...
						<div class="row">
                          ...
                          <div class="col-lg-7">
						   <input type="text" class="input-field" name="meta_keyword" placeholder="{{ __('Enter Meta Keyword') }}" required="" value="{{$data->meta_keyword}}">                            
                          </div>
                        </div>
						...
						<div class="row">
                          ...
                          <div class="col-lg-7">
						  <textarea class="nic-edit-p" name="meta_description" placeholder="{{ __('Enter Description') }}">{{$data->meta_description}}</textarea>
