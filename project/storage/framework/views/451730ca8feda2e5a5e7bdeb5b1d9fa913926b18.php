...
<?php $__env->startSection('content'); ?>  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading"><?php echo e(__('Media')); ?></h4>
										<ul class="links">
											<li>
												<a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a>
											</li>
											<li>
												<a href="javascript:;"><?php echo e(__('Media')); ?> </a>
											</li>
											<li>
												<a href="<?php echo e(route('admin-media-index')); ?>"><?php echo e(__('Medias')); ?></a>
											</li>
										</ul>
								</div>
							</div>
												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        ...
									                        <th width="70%"><?php echo e(__('URL')); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-media-datatables')); ?>',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="<?php echo e(route('admin-media-create')); ?>">'+
          '<i class="fas fa-plus"></i> <?php echo e(__('Add New Media Image')); ?>'+
          '</a>'+
          '</div>');
      });											
