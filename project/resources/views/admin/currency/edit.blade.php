                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Original Inr') }} *</h4>
                                <small>{{ __('Please Enter Original Inr Value ') }}</small>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="original_val" placeholder="{{ __('Enter Original Inr Value') }}" required="" value="{{$data->original_val}}">
                          </div>
                        </div>
