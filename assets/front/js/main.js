$(function ($) {
    ...
    if ($(".siz-list li").length > 0){ 
  if($('.siz-list li').hasClass('active')){
           $("#addcrt").removeClass("disabled-addtocrt"); 
       } else {
           $("#addcrt").addClass("disabled-addtocrt"); 
     ...
     $(".siz-list li").on("click", function() {
         $("#addcrt").removeClass("disabled-addtocrt"); 
        if($(this).hasClass('stock-0')){
           $(".right-area").addClass("product_os_hide"); 
       } else{
        $(".right-area").removeClass("product_os_hide");
       }
      ...
      $(".btn-close .ion-android-close").on("click", function() {
...
$("ul.siz-list").on("click", ".active", function() {
    $(this).closest(".siz-list ul").children('li:not(.active)').toggle();
});

var allOptions = $("ul.siz-list").children('li:not(.active)');
$("ul.siz-list").on("click", "ul.siz-list li:not(.active)", function() {
    allOptions.removeClass('selected');
    $(this).addClass('selected');
    $("ul.siz-list").children('.active').html($(this).html());
    allOptions.toggle();
});
...
setTimeout(function() { 
    ...
    var pricecart = $(".minicart-item_total .cart-total").html();
        

        $(".header-cart-total").html(pricecart);
...
setTimeout(function() { 
    ...
    var pricecartr = $(".minicart-item_total .cart-total").html();
        

        $(".header-cart-total").html(pricecartr);
