...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Refunds')); ?></h4>
				<ul class="links">
					<li><a href="<?php echo e(route('vendor-dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>
					<li><a href="javascript:;"><?php echo e(__('Refunds')); ?></a></li>					
				</ul>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-12">
				<div class="mr-table allproduct">
                 <?php echo $__env->make('includes.vendor.form-success', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>				
					...
					<div class="row">                    							
                                                <div class="text-left" >                                                    
                                                     <a href="<?php echo e(route('vendordw-raise-dispute',['status'=>'none'])); ?>" class="btn btn-warning" >Export</a>
                                                </div>
					...
					<!--<div class="row" style="padding-top : 20px; background : #eeeeee;">				                                                                     
							...
							<div class="form-group col-md-3">                               
                                <select name="status" id="status">
									...
									<option value='resolved'>Issued</option>								
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		   ...
		   ajax: {
                  url: "<?php echo e(route('vendor-raise-datatables','none')); ?>",
                  type: 'GET',
                  data: function (d) { 
