...
<div class="content-area">
  ...
  <div class="row row-cards-one tabs_cts">
	...
	<div  id="tab-1" class="tab-content current" >
        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            <form id="contactform" action="{{route('admin.revenue.submit')}}" method="POST">
                {{csrf_field()}}
...
@endphp
         ...
         <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                ...
                <div class="c-info-box-content">
                    <h6 class="title">{{ __('Gross Payment') }}</h6>
		...
		<div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                ...
                <div class="c-info-box-content">
                    <h6 class="title">{{ __('Net payment') }}</h6>
...
<div class="col-md-6 col-xl-3">
		 ...
		 <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                <div class="c-info-box box4">
                     <p>{{ App\Models\Currency::where('is_default','=','1')->get()->first()->sign }}
                        {{ round($admin_fee*18/100, 2)}}
                    </p>
                </div>
                <div class="c-info-box-content">
                    <h6 class="title">{{ __('Taxes') }}</h6>
							...
							<thead>
								<tr>
									...
									@php
                                        ...
                                        @endphp											
									<tr>
				                        <td><a href="{{ route('admin-order-show',$all_order['id'])}}">{{ $all_order['order_number'] }} <a></td>
                                        <td>{{ $OrderDetails['customer_name'] }}</td>
                                        <td>{{ $OrderDetails['customer_email'] }}</td>
                                        <td>{{ $OrderDetails['customer_phone'] }}</td>                                        
										<td>{{ $OrderDetails['totalQty'] }}</td>
                                        <td>{{ $OrderDetails['pay_amount']}}</td>
