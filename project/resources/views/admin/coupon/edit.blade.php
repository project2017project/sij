                      ...
                      <form id="geniusform" action="{{route('admin-coupon-update',$data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="cart_total_limit" placeholder="{{ __('Enter Code') }}" required="" value="{{$data->cart_total_limit}}">
                          </div>
                        </div>
                         <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="user_used_count" placeholder="{{ __('Enter Code') }}" required="" value="{{$data->user_used_count}}">
                          </div>
                        </div>
