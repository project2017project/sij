...
<div class="content-area">
	...
	<form id="addcreditnoteform" action="{{route('admin-creditnote-submit')}}" method="POST" enctype="multipart/form-data">
		{{csrf_field()}}
					...
					<div class="col-lg-12">
						<div class="product-description">
							<div class="body-area">						
                                    ...
                                    <option data-href="{{ route('order-crdit-load',$userid->id) }}" value="{{$userid->id}}">{{$userid->shop_name}}</option>
                                    @endforeach
					                    </select>
