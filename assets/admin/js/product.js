                                ...
                                '<span class="remove size-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Variation Name :'+
                                                '<span>(eg. Enter color, size and more)</span>'+
                                            '</label>'+
                                        ...
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Variation Qty :'+
                                            '<span>(Number of quantity of this Size or color)</span>'+
                                            '</label>'+
                                            '<input type="number" name="size_qty[]" class="input-field" placeholder="Size Qty" value="1" min="0">'+
                                        '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            ...
                                            '</label>'+
                                            '<input type="number" name="size_price[]" class="input-field var_price_s" placeholder="Size Price" value="0" min="0">'+
                                        '</div>'+
										'<div  class="row">'+
										'<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            ...
                                            '<span></span>'+
                                            '</label>'+
                                            '<input type="number" name="size_pre_price[]" class="input-field var_price_p" placeholder="Size Previous Price" value="0" min="0">'+
                                        '</div>'+
										'<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Upload Image :'+
...
if($("#size-check").is(':checked')) {
     $("input[name='price']").addClass('hidden');
     $("input[name='stock']").val("");
         $("input[name='stock']").addClass('hidden');
    $("input[name='previous_price']").addClass('hidden');
...
$("#size-check").change(function() {
    ...
    var pricevar = $("input[name='price']").val(0);
    var pricevars = $("input[name='previous_price']").val(0);
    
         $("input[name='price']").toggleClass('hidden');
         $("input[name='stock']").toggleClass('hidden');
    $("input[name='previous_price']").toggleClass('hidden');
