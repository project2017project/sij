					...
					<div class="mr-table allproduct">
                        <?php echo $__env->make('includes.admin.form-success', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
							<div class="table-responsiv">
							    <form id="geniusform" class="form-horizontal" action="<?php echo e(route('vendor-prod-vbulkstock-update')); ?>" method="POST" enctype="multipart/form-data">      
    						<?php echo e(csrf_field()); ?>

								<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
									<thead>
    									<tr>
					                        <th><?php echo e(__("Name")); ?></th><th><?php echo e(__("Type")); ?></th><th><?php echo e(__("Stock")); ?></th><th><?php echo e(__("Price")); ?></th><th><?php echo e(__("Regular Price")); ?></th><th><?php echo e(__("Options")); ?></th>
										</tr>
									</thead>
								</table>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('vendor-prod-vproductupdate-datatables')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'type', name: 'type' },
