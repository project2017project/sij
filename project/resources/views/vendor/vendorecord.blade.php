...
<div class="content-area">
  ...
  <div class="row row-cards-one tabs_cts">
	...
	<div  id="tab-1" class="tab-content current" >
        ...
        <div class="col-md-12 col-lg-12 col-xl-12">
            <form id="contactform" action="{{route('vendor.vendorrecord.submit')}}" method="POST">
                {{csrf_field()}}				 
			...
			<div class="col-md-6 col-xl-3">
				<a href="{{ route('exportreport',['startdate'=>$startdate,'enddate'=>$enddates]) }}" class="btn btn-info" >Export Filter Data</a>
				 </div>
			</div>        
			@endif
							...
							<thead>
								<tr>
									...
									@php
                                        ...
                                        @endphp										
									<tr>
				                        <td><a href="{{ route('vendor-order-vshow',$all_order['order_number'])}}">{{ $all_order['order_number'] }}</a></td>
