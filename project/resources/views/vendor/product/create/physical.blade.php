							...
							<div class="body-area">
								...
								<div class="gocover"
									...
									<div class="row">
										...
										<div class="col-lg-12"><input type="text" class="input-field" placeholder="{{ __('Enter Variation Title') }}" name="variation_title" ></div>
									</div>
													...
													<div class="size-area">
														...
														<div class="row">
															...
															<div class="col-md-4 col-sm-6">
																...
																<input type="number" name="size_price[]" class="input-field var_price_s"
