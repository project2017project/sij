...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Rto')); ?></h4>
				<ul class="links">
					<li><a href="<?php echo e(route('vendor-dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>
					<li><a href="javascript:;"><?php echo e(__('Rto')); ?></a></li>					
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="mr-table allproduct">					 
					...
					<div class="row">                    							
                                                <div class="text-left" >                                                    
                                                     <a href="<?php echo e(route('vendordw-rto-data',['status'=>'none'])); ?>" class="btn btn-warning" >Export</a>
                                                </div>
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		   ...
		   ajax: {
                  url: "<?php echo e(route('vendor-rto-datatables','none')); ?>",
                  type: 'GET',
                  data: function (d) { 
