		...
		if ($file = $request->file('photo'))
         {
            ...
            $file->move('assets/images/childcategory',$name);
            $input['photo'] = $name;
        }
		...
		if ($file = $request->file('photo'))
            {
                ...
                if($data->photo != null)
                {
                    if (file_exists(public_path().'/assets/images/childcategory/'.$data->photo)) {
                        unlink(public_path().'/assets/images/childcategory/'.$data->photo);
                    }
                }
            $input['photo'] = $name;
            }
