						<div class="shop-toolbar">
                            ...
                            <div class="product-item-selection_area">
                                <div class="product-short">
                                    <label class="select-label"><?php echo e($langg->lang64); ?> :</label>
                                    <form id="sortForm" class="d-inline-block" action="<?php echo e(route('front.vendor', Request::route('category'))); ?>" method="get">
							...
							<option value="popular_product" <?php echo e(request()->input('sort') == 'popular_product' ? 'selected' : ''); ?>>Popular Product</option>
