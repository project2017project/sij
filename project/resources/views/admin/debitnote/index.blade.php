...
<div class="content-area">
	...
	<form id="adddebitnoteform" action="{{route('admin-debitnote-submit')}}" method="POST" enctype="multipart/form-data">
		{{csrf_field()}}
					...
					<div class="col-lg-12">
						<div class="product-description">
							<div class="body-area">						
                                    ...
                                    <option data-href="{{ route('order-debit-load',$userid->id) }}" value="{{$userid->id}}">{{$userid->shop_name}}</option>
                                    @endforeach
					                    </select>
