...
@section('content')
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                               <div class="col-lg-12">
                      <h4 class="heading">{{ __('Credit Note Details') }} <a class="add-btn" href="{{route('admin-open-credit')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                          <a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }} </a>
                        </li>
                        <li>
                          <a href="javascript:;">{{ __('Credit Note Details') }}</a>
                        </li>                        
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        @endphp
												...
												<div class="row">
												<div class="col-md-6">
												<form  method="POST" action="{{route('admin-creditdocument-update',$data->id)}}" enctype="multipart/form-data" id="documentform">
												{{ csrf_field() }}
												...
												<div class="col-md-2">
												<form  method="POST" action="{{route('admin-creditrstatus-update',$data->id)}}" enctype="multipart/form-data" id="settlementform">
												{{ csrf_field() }}
												@include('includes.admin.form-both')
												<input type = "hidden" name="creditid" value="{{$data->id}}">
												...
												<div class="col-md-2">
												<form  method="POST" action="{{route('credit-cancel-status',$data->id)}}" enctype="multipart/form-data" id="settlementform">
												{{ csrf_field() }}
												@include('includes.admin.form-both')
