							...
							<div class="body-area">		
								<div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
    										...
    										<div class="col-lg-12">
    										    <div class="multi-category-box">
													...
													<div class="category_boxes">
														 <div class="parent">
														 <input type="checkbox" name="category_multi_id[]" value="{{$category->id}}" />{{ $category->name }}</div>
														 <div>
															<ul class="child">
																 @foreach($category->subs as $subcat)
																<li class="has-subcat">
																  <input type="checkbox" class="hassubchildren" name="subcategory_multi_id[]" value="{{$subcat->id}}" />{{$subcat->name}}
																	<ul class="sub-child">
																		 @foreach ($subcat->childs as $key => $childcat)
																		<li>
																		  <input type="checkbox" name="childcategory_multi_id[]" value="{{$childcat->id}}"  />{{$childcat->name}} 
																		</li>
																		@endforeach
																	</ul>
																</li>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<ul class="list"><li><input name="size_check" type="checkbox" id="size-check" value="1"> <label for="size-check"> {{ __('Enable Size') }}</label></li></ul>
										</div>
									</div>
													...
													<div class="size-area">
														...
														<div class="row">
															<div class="col-md-4 col-sm-6">
																<label>{{ __('Size Name') }} :<span>{{ __('(eg. Enter Size)') }}</span></label>
																<input type="text" name="size[]" class="input-field" placeholder="{{ __('Size Name') }}">
															</div>
															<div class="col-md-4 col-sm-6">
																<label>{{ __('Size Qty') }} :<span>{{ __('(Number of quantity of this Size)') }}</span></label>
																<input type="number" name="size_qty[]" class="input-field" placeholder="{{ __('Size Qty') }}" value="1" min="1">
															</div>
															<div class="col-md-4 col-sm-6">
																<label>{{ __('Size Price') }} :<span>{{ __('(This price will be added with base price)') }}</span></label>
