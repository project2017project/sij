													...
													<div class="col-lg-12">
														<ul class="list">
															<li>
																...
																<label for="size-check">{{ __('Allow Product Variation') }}</label>
															</li>
														</ul>
													</div>
												</div>
																	 ...
																	 @foreach($data->size as $key => $data1)
																		...
																		<div  class="row">
																				...
																				<div class="col-md-4 col-sm-6">
																					...
																					<input type="number" name="size_qty[]" class="input-field" placeholder="Variation Qty" min="1" value="{{ $data->size_qty[$key] }}">
																				</div>
																				<div class="col-md-4 col-sm-6">
																						<label>
																							{{ __('Variation Price') }} :
																					...
																					<input type="number" name="size_price[]" class="input-field" placeholder="{{ __('Variation Price') }}" min="0" value="{{ $data->size_price[$key] }}">
																				</div>
																			</div>
																		</div>
																	 @endforeach
