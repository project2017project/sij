...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Exchange')); ?> 				
				<ul class="links">
					<li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>					
					<li><a href="javascript:;"><?php echo e(__('Add Exchange')); ?></a></li>					
				</ul>
			</div>
		</div>
	</div>

	<form id="exxchangedform" action="<?php echo e(route('addstore-exchangeod-submit')); ?>" method="POST" enctype="multipart/form-data">
...
<table class="table">
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									...
									<div class="row">
										...
										<div class="col-lg-12"><input type="number" class="input-field rdqty" placeholder="<?php echo e(__('Quantity')); ?>" name="quantity" min="1" value="<?php echo e($alldata->qty-$vender_data->product_item_qty); ?>" required=""></div>
									</div>
                                   ...
                                   <div class="row">
									...
									<div class="row">
										...
										<div class="modal fade" id="exchangemod" tabindex="-1" role="dialog" aria-labelledby="exchangemod" aria-hidden="true">                        
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">            
            <div class="modal-body">
                <p class="text-center">Are you Sure You want to Create Exchange Request?</p>
				<button class="addexchanges-btn btn btn-success" style="margin-top : 0; width:auto; height:auto; font-size : 1rem; 
    background-color: #28a745; border: 1px solid transparent; border-color: #28a745;" type="submit"><?php echo e(__('Confirm')); ?></button>
                <button type="button" class="btn btn-danger" data-dismiss="modal"><?php echo e(__('Cancel')); ?></button>
												...
												<a href="javascript:;" class="btn btn-info" data-toggle="modal" data-target="#exchangemod"><?php echo e(__('Add')); ?></a>
										</div>
									</div>
							</div>
						</div>
