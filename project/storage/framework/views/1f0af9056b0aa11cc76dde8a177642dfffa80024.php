...
<div class="content-area">
	...
	<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Decline Debit Note')); ?> 				
				<ul class="links">
					<li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>					
					<li><a href="javascript:;"><?php echo e(__('Decline Debit Note')); ?></a></li>					
				</ul>
			</div>
		</div>		
	</div>
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		   ...
		   ajax: {
                  url: "<?php echo e(route('admin-load-decline-debit','none')); ?>",
                  type: 'GET',
                  data: function (d) {    
