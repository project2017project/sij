...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__('Create Refund')); ?> 				
				<ul class="links">
					<li><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?> </a></li>					
					<li><a href="javascript:;"><?php echo e(__('Create Refund Request')); ?></a></li>					
				</ul>
			</div>
		</div>
	</div>

	<form id="raisedisputeform" action="<?php echo e(route('admin-raisedispute-submit')); ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="col-lg-12">
						<div class="product-description">
							<div class="body-area">						
                                    ...
                                    <option data-href="<?php echo e(route('order-data-load',$userid->id)); ?>" value="<?php echo e($userid->id); ?>"><?php echo e($userid->shop_name); ?></option>
