			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="links">
						...
						<li><a href="<?php echo e(route('vendor-prod-index')); ?>"><?php echo e(__("All Products")); ?></a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="mr-table allproduct">
					...
					<div class="table-responsiv">
                        ...
                        <br>
					    <form id="geniusform" class="form-horizontal" action="<?php echo e(route('admin-vendorprod-price-update')); ?>" method="POST" enctype="multipart/form-data">      
							...
							<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
								<thead>
									<tr>
				                        ...
				                        <th><?php echo e(__("Stock")); ?></th><th><?php echo e(__("Price")); ?></th><th><?php echo e(__("Categories")); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
		var table = $('#geniustable').DataTable({
               ...
               serverSide: true,
               ajax: {
                  url: "<?php echo e(route('vendor-prod-datatables')); ?>",
                  type: 'GET',
                  data: function (d) {
                    d.category         = $('#cat').val();
                    d.subcat           = $('#subcat').val();
       ...
       $(function() {
            $(".btn-area").append('<div class="col-sm-2 table-contents">'+
              '<a class="add-btn" href="<?php echo e(route('vendor-prod-vproductupdate')); ?>">'+
              '<i class="fas fa-plus"></i> <span class="remove-mobile"><?php echo e(__("Product Update")); ?><span>'+
              '</a>'+
              '</div>');
        });
