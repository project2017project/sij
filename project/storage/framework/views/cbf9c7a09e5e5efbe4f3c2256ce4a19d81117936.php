...
<div class="content-area">
	...
	<form id="addcreditnoteform" action="<?php echo e(route('admin-creditnote-submit')); ?>" method="POST" enctype="multipart/form-data">
					...
					<div class="col-lg-12">
						<div class="product-description">
							<div class="body-area">						
                                    ...
                                    <option data-href="<?php echo e(route('order-crdit-load',$userid->id)); ?>" value="<?php echo e($userid->id); ?>"><?php echo e($userid->shop_name); ?></option>
									...
									<div class="row">
										<div class="col-lg-12 text-center">										
											<button class="addcreditnoteform-btn"
