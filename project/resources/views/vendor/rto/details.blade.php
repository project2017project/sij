...
@section('content')
                    ...
                    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                               <div class="col-lg-12">
                      <h4 class="heading">{{ __('Rto Details') }} <a class="add-btn" href="{{route('vendor-rto-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                          <a href="{{ route('vendor-dashboard') }}">{{ __('Dashboard') }} </a>
                        </li>
                        <li>
                          <a href="javascript:;">{{ __('Rto') }}</a>
                        </li>                        
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        @endphp
												...
												<?php } ?>
												<form  method="POST" action="{{route('vendor-rto-update',$data->id)}}" enctype="multipart/form-data" id="rtoshipform">
												{{ csrf_field() }}
